	...
	<div class="col-sm-6 col-md-9 col-lg-9 p-b-50">
	 ...
	 <table class="table">
		...
		<tbody>
			...
			<tr>
				<td>Telepon</td>
				<td><input type="number" name="telepon" class="form-control" placeholder="Telepon" value="<?php echo $pelanggan->telepon ?>" required></td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td><textarea name="alamat" class="form-control" placeholder="Alamat" value=""><?php echo $pelanggan->alamat ?></textarea></td>
			</tr>
			<tr>
				<td></td>
				<td>
