	 ...
	 <table class="table">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" name="email" class="form-control" placeholder="Email/Username" value="<?php echo set_value('email') ?>"></td>
			</tr>
			<tr>
				<td>Password</td>
				<td><input type="password" name="password" class="form-control" id="password" placeholder="Password" value="<?php echo set_value('password') ?>"></td>
