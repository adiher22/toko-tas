 ...
 ?>
  ...
  <div class="form-group form-group-lg">
    ...
    <div class="form-group">
      <label  class="col-sm-3 control-label">Upload Logo Baru</label>
      <div class="col-md-8">
        <input type="file" name="logo" class="form-control"  placeholder="Upload Logo Baru" value="<?= $konfigurasi->logo; ?>" required>
        Logo lama : <br>
        <img src="<?= base_url('assets/upload/image/'.$konfigurasi->logo); ?>" class="img img-responsive img-thumbnail" width="">
      </div>
    </div>
    <div class="form-group">
