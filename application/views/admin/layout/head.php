...
<head>
  ...
  <title><?=  $title; ?></title>
  <link rel="icon" type="image/png" href="<?= base_url('assets/upload/image/amazon-icon.png');?>"/>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/dist/js/jquery-ui.min.css'); ?>"  />
